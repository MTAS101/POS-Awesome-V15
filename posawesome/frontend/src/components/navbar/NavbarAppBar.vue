<template>
  <v-app-bar app flat height="56" :color="appBarColor" :theme="isDark ? 'dark' : 'light'"
    ...
    <!-- Update path to POS Awesome logo after moving to frontend -->
    <v-img src="/assets/posawesome/frontend/components/pos/pos.png" alt="POS Awesome" max-width="32" class="mx-2" />
