// Load Dexie from the new frontend path so the service worker can cache it
// along with the rest of the frontend bundle.
importScripts('/assets/posawesome/frontend/libs/dexie.min.js');
