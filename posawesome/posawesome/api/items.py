...
@frappe.whitelist()
def get_item_variants(item_code, pos_profile, price_list=None, customer=None):
    """Return all variant items for the given template."""
    ...
    item_prices_data = frappe.get_all(
        ...
        or_filters=[["valid_upto", ">=", nowdate()], ["valid_upto", "in", ["", None]]],
    ...
    for item in items_data:
        ...
        item_barcode = frappe.get_all(
            "Item Barcode", filters={"parent": item_code}, fields=["barcode", "posa_uom"]
        )
        uoms = frappe.get_all(
